...
namespace API.Data.Migrations
{
    ...
    [Migration("20210609121542_TimesheetModule2")]
    partial class TimesheetModule2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Project", b =>
                {
                    ...
                    b.Property<string>("ProductionStageStatus")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Models.TimesheetMonth", b =>
                {
                    b.Property<int>("TMonthId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("TimesheetMonths");
                });

            modelBuilder.Entity("API.Models.TimesheetWeek", b =>
                {
                    b.Property<int>("TWeekId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Models.Timesheet", b =>
                {
                    b.HasOne("API.Models.TimesheetWeek", "TWeek")
                        .WithMany()
                        .HasForeignKey("TWeekId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Models.TimesheetWeek", b =>
                {
                    b.HasOne("API.Models.TimesheetMonth", "TMonth")
                        .WithMany()
                        .HasForeignKey("TMonthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
